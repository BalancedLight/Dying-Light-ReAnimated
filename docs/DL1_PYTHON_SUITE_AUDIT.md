...
- `[local Python oracle checkout]\tools\audit_dl1_python_suite.py`
...
```powershell
python "[local Python oracle checkout]\tools\audit_dl1_python_suite.py" `
  --repository-root "[local Python oracle checkout]"
```
...
.\tools\validate_dl1_python_suite_audit.ps1 `
  ...
  -PythonOracleRoot "[local Python oracle checkout]"
```
