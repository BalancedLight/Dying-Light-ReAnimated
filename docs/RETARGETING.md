...
The exporter reads the FBX's unanimated transforms and uses them as the source rest reference. This was verified against the separate Mixamo T-pose workflow: the generated full-body control ANM2 payload is byte-identical in both modes.
