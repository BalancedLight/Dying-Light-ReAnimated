    ...
    *,
    ...
    summary = {
        ...
        "corrections_from_previous_pack": [
            ...
            "removed the source T-pose-to-standing offset by making all motion relative to full-body control frame 0",
...
The greeting is now made relative to **full-body control frame 0**. The Mixamo T-pose-to-standing offset is no longer added on top of a standing Dying Light pose. Only primary deform tracks are animated; `r_uparmtwist`, forearm twist tracks, `r_hand1`, and `r_handholder` remain at bind.
