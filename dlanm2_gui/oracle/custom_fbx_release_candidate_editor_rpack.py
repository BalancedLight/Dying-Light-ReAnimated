    ...
    *,
    ...
    summary = {
        ...
        "editor_confirmation": {
            ...
            "result": "matches Mixamo full-body control body pose in editor",
...
`dl_reanimated_fbxfix_fullbody_hf_absolute` was visually confirmed in the editor to match the Mixamo `full-body control` body pose. The source FBX Euler evaluator, target SMD bind pose, hierarchy, ANM2 Cayley rotation encoding, packed writer, and RPack delivery route are therefore protected known-good systems.
...
The Dying Light editor visually confirmed that `dl_reanimated_fbxfix_fullbody_hf_absolute` matches the Mixamo `full-body control` body pose. This closes the core full-body rotation-retarget problem for the tested standard Mixamo 65-bone skeleton and the standard `player_1_tpp` Dying Light skeleton.
