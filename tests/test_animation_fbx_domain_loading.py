...
CORPUS_ROOT = Path(r"[local external corpus]")
CORPUS_EXPECTATIONS = (
    ("external-animation-control.fbx", 154, 150),
    ("external-animation-control.fbx", 86, 159),
    ("external-animation-control.fbx", 36, 159),
    ("external-animation-control.fbx", 135, 69),
    ("external-animation-control.fbx", 897, 159),
    ("external-animation-control.fbx", 567, 159),
    ("external-animation-control.fbx", 769, 159),
    ("external-animation-control.fbx", 1113, 159),
    ("external-animation-control.fbx", 45, 69),
    ("external-animation-control.fbx", 78, 69),
    ("external-animation-control.fbx", 2, 0),
)
...
@pytest.mark.skipif(
    not (CORPUS_ROOT / "external-animation-control.fbx").is_file(),
    reason="external compatibility corpus is not installed",
)
def test_real_quad_heavy_file_preflight_reports_ignored_model_domain() -> None:
    path = CORPUS_ROOT / "external-animation-control.fbx"
...
def test_static_t_pose_preflight_is_importable_as_rest_pose() -> None:
    report = preflight_fbx(CORPUS_ROOT / "external-animation-control.fbx", purpose="animation")
